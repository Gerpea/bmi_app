...
/// [MyRangeSlider] uses this callback to paint the value indicator on the overlay.
...
class _MyRangeSliderState extends State<MyRangeSlider>
  ...
  @override
  void didUpdateWidget(MyRangeSlider oldWidget) {
  ...
  Thumb? _defaultRangeThumbSelector(
    ...
    final double touchRadius =
        math.max(thumbSize.width, MyRangeSlider._minTouchTargetWidth) / 2;
...
class _RangeSliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  final ValueChanged<RangeValues>? onChangeEnd;
  final SemanticFormatterCallback? semanticFormatterCallback;
  final _MyRangeSliderState state;
...
class _RenderRangeSlider extends RenderBox
  ...
  _RenderRangeSlider({
    ...
    required this.onChangeStart,
    required this.onChangeEnd,
    required _MyRangeSliderState state,
  ...
  final _MyRangeSliderState _state;
...
class _RenderValueIndicator extends RenderBox
  ...
  late Animation<double> _valueIndicatorAnimation;
  late _MyRangeSliderState _state;
